        ...
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              Web development has never been easier! UI/UX design, frontend and
              backend development
            </p>
          </div>
      ...
      <section className="bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">
            Intergrate Your Business With AI
          </h1>
          <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
            AI is the future of business. Integrate your business with AI to
            improve efficiency and productivity
          </p>
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a
              href="https://www.linkedin.com/pulse/ultimate-guide-incorporating-ai-your-business-boost-bottom/"
            ...
            <a
              href="https://youtu.be/Le122vas9aM?si=NQHnvQGE026Mjt4N&t"
              className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-200 rounded-lg border border-gray-300 hover:bg-gray-400 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800"
            >
              <svg
